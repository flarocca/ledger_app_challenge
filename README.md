...
This section contains references to my own material that I usually prove I've been following these approaches long before the IA Coding agents era.
All links point to my own github and youtube talks I gave in the past.

Sorry for the YouTube videos, most of them are in Spanish!

### Repository pattern

In this repository you can find an example implementation implementing the Repository Pattern, using an InMemory version of Sqlite for integration testing

- https://github.com/flarocca/facutherock.talks.net.eftesting/
- https://youtu.be/_PTKT3BjjVQ?si=tYnCfXw0uf7cc89J

### Cached Repository

- https://github.com/flarocca/TMenos3.Courses.NetCore.DistributedCache/tree/cached-repository-api

### Tracing & logging

Even though this is .Net specific implementation using Serilog, it is still a standard I've been using in all APIs

- https://github.com/flarocca/api-rate-limit-challenge
- https://github.com/flarocca/tmenos3.netcore.serilog
- https://youtu.be/JMQPW3yvAOE?si=UofbvdzjjcF71fKG

### API Versioning

I didn't implement API versioning in this app, but this is how I would if I had to

- https://github.com/flarocca/facutherock.talks.net.versioning
- https://youtu.be/9g-n-S9HHb8?si=hQ6WA79yPn5Kodr7&t=1

### System Clock mocking

This is an example of an injectable SystemClock that makes mocking time possible. DoeNet provides the pattern out of the box, but Rust doesn't (or I am not aware of it),
so I asked Claude to build one using the example in this repository. It is needed to test session rolling windows and expiration

- https://github.com/flarocca/facutherock.articles.net.systemclock

### API & Project Structure

This is also an example of how to implement and manage message brokers such as RabbitMQ

- https://github.com/flarocca/rust_api_demo
- https://github.com/flarocca/tmenos3.netcore.apidemo
- https://github.com/flarocca/file_server_challenge
- https://github.com/flarocca/api-rate-limit-challenge

### Error handling

- https://www.youtube.com/live/8qVuM8FMEuw?si=BgX1f4ClrrDtqTWK

### WebServer and WebSocket Simulator

These are examples of how to run the whole API for testing purposes, injecting dependencies and mocks if needed.
In this case there are no mocks

- https://github.com/flarocca/hedge_bot_rust/blob/main/tests/helpers/websocket_simulator.rs
- https://github.com/flarocca/hedge_bot_rust/blob/main/tests/helpers/webserver_simulator.rs

### YouTube Playlist

- https://www.youtube.com/playlist?list=PLXxh_6Svk-KzblU8pz4LcgbfP_fbgg7jL
